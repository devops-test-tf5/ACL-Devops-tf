...
public class UserLoggedInDetails {
	...
	public UserLoggedInDetails(Long userId, String sessionId, String jwtType, String jwt, Instant jwtCreatedTime,
			Instant jwtExpiryTime, char loggedIn, Instant loggedInTime) {
		super();
		this.userId = userId;
		this.sessionId = sessionId;
		this.jwtType = jwtType;
