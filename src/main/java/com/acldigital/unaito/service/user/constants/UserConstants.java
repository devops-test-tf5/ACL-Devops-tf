...
public class UserConstants {
	...
	public static final String DUPLICATE_USERNAME = "Username is duplicate. Please try with a new username.";
	...
	public static final Integer RANDOM_STRING_LENGTH_TEN = 10;
	public static final Integer RANDOM_STRING_LENGTH_SIXTY_FOUR = 64;
	public static final String LOGOUT_SUCCESS = "Logged out successfully.";

	// Status names
	public static final String NEW = "NEW";
	public static final String RETRY = "RETRY";
	public static final String MAX_RETRY_CONSUMED = "MAX_RETRY_CONSUMED";
